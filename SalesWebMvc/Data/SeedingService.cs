...
using System.Linq; // para usa o Any
using System; // para usar o DateTime
using SalesWebMvc.Models.Enums; //para usar o SalesRecord

namespace SalesWebMvc.Data {
    public class SeedingService {
        private SalesWebMvcContext _context; // injecao de dependencia

        public SeedingService(SalesWebMvcContext context) { //construtor
            _context = context;
        }
        public void Seed() {  //essa operação vai popular a base de dados
            if (_context.Department.Any() ||
                _context.Seller.Any() ||
                _context.SalesRecord.Any()) {
                return;
                // teste se ja existe algum dado na minha base de dados, Any testa se existe algum registro
                // na tabela que eu coloquei, se ja existir dou um return para cortar a execução
            }
            // agora vou popular meu BD, vou instanciar os objetos e mandar salvar no BD
            Department d1 = new Department(1, "Computers");
            Department d2 = new Department(2, "Electronicas");
            Department d3 = new Department(3, "Fashion");
            Department d4 = new Department(4, "Books");
            // poderia fazer sem o construtor ficaria assim
            // Department d5 = new Department { Id = 1, Name = "Kipper" };
            ...
            Seller s4 = new Seller(4, "Martha Red", "martha@gmail.com", new DateTime(1993, 11, 30), 1000.0, d1);
            Seller s5 = new Seller(5, "Donald Blue", "donald@gmail.com", new DateTime(2000, 1, 9), 1000.0, d1);
            Seller s6 = new Seller(6, "Alex Pink", "alexpink@gmail.com", new DateTime(1997, 3, 4), 1000.0, d1);
            ...
            //agora vamos mandar adicionar esses dados no BD usando o entiti framework
            _context.Department.AddRange(d1, d2, d3, d4); //addrange, permite que adicione varios objetos de uma vez
            ...
            _context.SaveChanges(); //salva e confirmar as alteracoes no BD
